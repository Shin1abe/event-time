...
// https://codepen.io/collection/ZMGZbL
const HeaderB = () => {
  return (
    <>
      <nav className="relative bg-white border-b-2 border-gray-300 text-gray-900  relative">
        <div className="container mx-auto flex justify-between">
		  ...
		  <li className="toggleable"><input type="checkbox" value="selected" id="toggle-xxx" className="toggle-input"><label for="toggle-xxx" className="cursor-pointer"/>Click</label><div role="toggle" className="mega-menu">
